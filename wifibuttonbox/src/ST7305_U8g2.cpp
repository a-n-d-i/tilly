// Vendored from Waveshare's ESP32-S3-RLCD-4.2 example repo (Apache-2.0):
// https://github.com/waveshareteam/ESP32-S3-RLCD-4.2
// (02_Example/Arduino/10_U8G2_Test/ST7305_U8g2.*), with one change: 0x21
// (INVON) below swapped for 0x20 (INVOFF) for a bright background / dark
// ink polarity instead of the vendor default.
...
void ST7305_U8g2::fullInit()
{
  ...
  _cmd(0x20);  // INVOFF: bright background, dark ink (vendor default is 0x21/INVON)
